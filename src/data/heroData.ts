...
export const heroData: Record<string, HeroData> = {
  ...
  limpieza: {
    ...
    lines: [
      "+ de <strong>8.000</strong> empresas lo utilizan diariamente.",
      "+ de <strong>50.000</strong> emprendedores confían en MN program.",
      "+ de <strong>98%</strong> de opiniones positivas.",
    ],
    buttons: {
      video: "Ver vídeo",
  ...
  ingenieros: {
    ...
    lines: [
      "+ de <strong>8.000</strong> empresas lo utilizan diariamente.",
      "+ de <strong>50.000</strong> ingenieros confían en MN program.",
      "+ de <strong>98%</strong> de opiniones positivas.",
    ],
    buttons: {
      video: "Ver vídeo",
  ...
  odontologos: {
    ...
    lines: [
      "+ de <strong>5.000</strong> clínicas lo utilizan diariamente.",
      "+ de <strong>20.000</strong> odontólogos confían en MN program.",
      "+ de <strong>98%</strong> de opiniones positivas.",
    ],
    buttons: {
      video: "Ver vídeo",
  ...
  procuradores: {
    ...
    lines: [
      "+ de <strong>8.000</strong> despachos lo utilizan diariamente.",
      "+ de <strong>50.000</strong> procuradores confían en MN program.",
      "+ de <strong>98%</strong> de opiniones positivas.",
    ],
    buttons: {
      video: "Ver vídeo",
