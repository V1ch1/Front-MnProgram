...
const OdontologosAds3: React.FC = () => {
  return (
    <div>
      <TopBannerDegrad colectivo="Odontólogos Ads 3" />
      <HeroComponentDegrad colectivo="Odontólogos Ads 3" />
      <Block1Ads
        iconBackgroundColor={{
        ...
        iconColor="white"
      />
      <Block2AdsDegrad colectivo="Odontólogos Ads 3" />
      <Block3Ads
...
export default OdontologosAds3;
