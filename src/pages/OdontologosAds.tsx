...
const OdontologosAds: React.FC = () => {
  return (
    <div>
      <TopBanner colectivo="Odontólogos Ads 1" />
      <HeroComponentAds2 colectivo="Odontólogos Ads 1" />
      <Block1Ads />
      <Block2Ads colectivo="Odontólogos Ads 1" />
      <Block3Ads
      ...
      />
      <Block4Ads colectivo="Odontólogos Ads 1" />
      <ButtonWhatsapp />
      <FooterAds />
    </div>
  );
